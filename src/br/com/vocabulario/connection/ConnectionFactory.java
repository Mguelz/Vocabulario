...
public class ConnectionFactory {
	public void conectar() {
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:oracle:thin:@oracle.fiap.com.br:1521:ORCL","root", "root"); // ("jdbc:oracle:thin:@oracle.fiap.com.br:1521:ORCL","root", "root") 
 ...
 * public void connectionFactory() {
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:oracle:thin:@oracle.fiap.com.br:1521:ORCL","tm_miguel_lima", "101204"); // ("jdbc:oracle:thin:@oracle.fiap.com.br:1521:ORCL","root", "root") 
